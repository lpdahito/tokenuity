// docker run -it --rm --link mongo-server --env-file .env --env CHAIN_ID=8453 -v /Users/lpdahito/Projects/tokenuity/trends-explorer/dist:/app/dist explorer node -e 'require("./dist/playground/dextools/getToken.js").default()'

import { getDextScore } from "./../../helpers/dextools"
...
export default async () => {
  ...
  try {
    const dextScoreData = await getDextScore(a)

    console.log(dextScoreData)
  } catch (err: any) {
    console.log(err)
  }
}
