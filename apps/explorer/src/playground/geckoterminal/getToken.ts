// docker run -it --rm --link mongo-server --env-file .env --env CHAIN_ID=8453 -v /Users/lpdahito/Projects/tokenuity/trends-explorer/dist:/app/dist explorer node -e 'require("./dist/playground/geckoterminal/getToken.js").default()'

import { getGeckoTerminalData } from "./../../helpers/geckoterminal"
...
export default async () => {
  ...
  a = '0x3aAf8a9e6c2A63aF24c97cB29121D19C1cc10993'
  a = '0xaad0757D560a322373C8DA887007df9c7591fd25'
  a = '0x15FD93Cc2dc210a7Ee3C6aa9Aa0a36803Dc3Bb3b'
  a = '0x4037f2267783D17f7396bb777dA8bE4d19Ac9918'
  a = '0x348eE0e869A518F5aEFe3237c7109c57B65D7A23'
  a = '0x68Aacef68513eF44cD22E68A6c622BF9832bE828'

  try {
    const geckoTerminalData = await getGeckoTerminalData(a)
